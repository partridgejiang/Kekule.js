(function() {
	...
	var moduleUrl = "{{MODULE_URL}}";  // a special tag, to be replaced with actual url getter code like 'import.meta.url' or '__filename';
	var modulePath = "{{MODULE_PATH}}";  // a special tag, to be replaced with actual path getter code like '__dirname';
